...
<script>
  export default {
    ...
    data() {
      return {
        ...
        counter: {
          ...
          df_total_used_percent: 'df.total.userd.percent', //存储使用率
        }
      };
    },
    ...
    mounted() {
      ...
      this.initChart([[39.5, 54.9, 47.5, 51.2, 78.5, 51.8], [37.9, 50.6, 43.6, 40.1, 43.7, 46.7], [35.3, 43.2, 42.1, 13.2, 42.9, 44.2],
        [15.7, 41.9, 39.7, 1.2, 41.5, 39.1], [15.5, 37.5, 39.6, 1.1, 39.3, 32.1]]);
    },
    methods: {
      // 物理机资源利用率
